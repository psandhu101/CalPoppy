...
export default function GreetingCard() {
  ...
  const descriptionText = `Welcome to the Alpha version of Poppy Chat! 
   Ask Poppy about Swanton Pacific Ranch!
   Check out how to use Poppy and about FAQs by clicking the question mark above.
   Please note Poppy is a child and is learning more vocabulary every day.
